module MissionDeployment {
  ...
  # GPIO
  instance red_led: Components.LedControl base id 0x22000
  instance green_led: Components.LedControl base id 0x23000
  instance blue_led: Components.LedControl base id 0x24000

  instance mpu6050: Components.Mpu6050 base id 0x10000
  
  instance i2cDriver: Arduino.I2cDriver base id 0x12000

  instance payload: Components.Payload base id 0x25000
}
