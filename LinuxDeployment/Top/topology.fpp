module LinuxDeployment {
  ...
  topology LinuxDeployment {
    ...
    connections RateGroups {
      ...
      rateGroup1.RateGroupMemberOut[3] -> imu.run
    ...
    connections LinuxDeployment {
      imuCtrl.controlAxis -> imu.setAxis

      # New: Payload-1 data path - Imu publishes a sample, Payload consumes it, AI
      imu.ImuDataOut -> payload.accelIn
    }
