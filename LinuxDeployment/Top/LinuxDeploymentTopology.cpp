// ======================================================================
// \title  LinuxDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <LinuxDeployment/Top/LinuxDeploymentTopologyAc.hpp>
#include <LinuxDeployment/Top/LinuxDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(LinuxDeploymentPacketsPkts, LinuxDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name LinuxDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        LinuxDeployment::blockDrv.callIsr();
