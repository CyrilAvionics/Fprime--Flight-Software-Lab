// ======================================================================
// \title  LinuxDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef LINUXDEPLOYMENT_LINUXDEPLOYMENTTOPOLOGY_HPP
#define LINUXDEPLOYMENT_LINUXDEPLOYMENTTOPOLOGY_HPP
// Included for access to LinuxDeployment::TopologyState and LinuxDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <LinuxDeployment/Top/LinuxDeploymentTopologyDefs.hpp>

// Remove unnecessary LinuxDeployment:: qualifications
using namespace LinuxDeployment;
namespace LinuxDeployment {
/**
 ...
 * LinuxDeployment::TopologyState see: LinuxDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type LinuxDeployment::TopologyState see: LinuxDeploymentTopologyDefs.hpp.
 *
