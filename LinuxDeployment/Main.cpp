...
#include <LinuxDeployment/Top/LinuxDeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    LinuxDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    LinuxDeployment::TopologyState inputs;
    ...
    LinuxDeployment::setupTopology(inputs);
    LinuxDeployment::startSimulatedCycle(100);  // Program loop cycling rate groups at 1Hz
    LinuxDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
